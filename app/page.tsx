...
export default async function Home({
  ...
  const sort: TaskSortColumn | undefined =
    sortParam && sortParam in taskSortColumns
      ? (sortParam as TaskSortColumn)
      : undefined;
  ...
  const tasks = userId
    ? await getTasksByUserIdPaginated(
        userId,
        currentPage,
        PAGE_SIZE,
        sort,
                        ...
                        <TableRow key={task.id}>
                          ...
                          <TableCell className="text-right">
                            <div className="flex items-center justify-end gap-2">
                              <CompleteTaskDialog task={{ id: task.id, title: task.title, completed: !!task.completed }} />
