---
name: best-practice-react-components
description: Build clean, modern React components that apply comman best practices and avoid comman pitfalls like unnecessary state management or useEffect usage
---
